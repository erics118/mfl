  $ dune exec mfl -- fixtures/ternary.mfl
  ; ModuleID = 'mfl'
  source_filename = "mfl"
  ...
  define i32 @ternary(i1 %cond, i32 %x, i32 %y) {
  entry:
    ...
    %cond4 = load i1, ptr %cond1, align 1
    br i1 %cond4, label %ternary_then, label %ternary_else
